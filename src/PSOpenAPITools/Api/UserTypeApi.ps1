...
function New-UserType {
    ...
    Process {
        'Calling method: New-UserType' | Write-Debug
...
None
#>
function Invoke-DeleteUserType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeleteUserType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-UserType {
    ...
    Process {
        'Calling method: Get-UserType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Invoke-ListUserTypes {
    ...
    Process {
        'Calling method: Invoke-ListUserTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
UserType
#>
function Invoke-ReplaceUserType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ReplaceUserType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-UserType {
    ...
    Process {
        'Calling method: Update-UserType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
