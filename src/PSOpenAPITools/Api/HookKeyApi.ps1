...
function Add-HookKey {
    ...
    Process {
        'Calling method: Add-HookKey' | Write-Debug
...
function Invoke-DeleteHookKey {
    ...
    Process {
        'Calling method: Invoke-DeleteHookKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-HookKey {
    ...
    Process {
        'Calling method: Get-HookKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-PublicKey {
    ...
    Process {
        'Calling method: Get-PublicKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Invoke-ListHookKeys {
    ...
    Process {
        'Calling method: Invoke-ListHookKeys' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
HookKey
#>
function Invoke-ReplaceHookKey {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ReplaceHookKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
