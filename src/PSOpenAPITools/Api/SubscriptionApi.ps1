...
Subscription
#>
function Get-RoleSubscriptionByNotificationType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-RoleSubscriptionByNotificationType' | Write-Debug
...
Subscription
#>
function Get-UserSubscriptionByNotificationType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-UserSubscriptionByNotificationType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Subscription[]
#>
function Invoke-ListRoleSubscriptions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ListRoleSubscriptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Subscription[]
#>
function Invoke-ListUserSubscriptions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ListUserSubscriptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-SubscribeRoleSubscriptionByNotificationType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-SubscribeRoleSubscriptionByNotificationType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-SubscribeUserSubscriptionByNotificationType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-SubscribeUserSubscriptionByNotificationType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-UnsubscribeRoleSubscriptionByNotificationType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-UnsubscribeRoleSubscriptionByNotificationType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-UnsubscribeUserSubscriptionByNotificationType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-UnsubscribeUserSubscriptionByNotificationType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
