...
LogStream
#>
function Invoke-ActivateLogStream {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ActivateLogStream' | Write-Debug
...
function New-LogStream {
    ...
    Process {
        'Calling method: New-LogStream' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LogStream
#>
function Invoke-DeactivateLogStream {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeactivateLogStream' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-DeleteLogStream {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeleteLogStream' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-LogStream {
    ...
    Process {
        'Calling method: Get-LogStream' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LogStream[]
#>
function Invoke-ListLogStreams {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ListLogStreams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LogStream
#>
function Invoke-ReplaceLogStream {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ReplaceLogStream' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
