...
function Add-RolePermission {
    ...
    Process {
        'Calling method: Add-RolePermission' | Write-Debug
...
function Invoke-DeleteRole {
    ...
    Process {
        'Calling method: Invoke-DeleteRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-DeleteRolePermission {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeleteRolePermission' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-RolePermission {
    ...
    Process {
        'Calling method: Get-RolePermission' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Permissions
#>
function Invoke-ListRolePermissions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ListRolePermissions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Invoke-ReplaceRole {
    ...
    Process {
        'Calling method: Invoke-ReplaceRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
