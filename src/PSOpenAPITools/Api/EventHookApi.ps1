...
EventHook
#>
function Invoke-ActivateEventHook {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ActivateEventHook' | Write-Debug
...
function New-EventHook {
    ...
    Process {
        'Calling method: New-EventHook' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
EventHook
#>
function Invoke-DeactivateEventHook {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeactivateEventHook' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-DeleteEventHook {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeleteEventHook' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-EventHook {
    ...
    Process {
        'Calling method: Get-EventHook' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
EventHook[]
#>
function Invoke-ListEventHooks {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-ListEventHooks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-EventHook {
    ...
    Process {
        'Calling method: Update-EventHook' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Test-EventHook {
    ...
    Process {
        'Calling method: Test-EventHook' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
