...
function Get-ApiToken {
    ...
    Process {
        'Calling method: Get-ApiToken' | Write-Debug
...
function Invoke-ListApiTokens {
    ...
    Process {
        'Calling method: Invoke-ListApiTokens' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Revoke-ApiToken {
    ...
    Process {
        'Calling method: Revoke-ApiToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Revoke-CurrentApiToken {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Revoke-CurrentApiToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
