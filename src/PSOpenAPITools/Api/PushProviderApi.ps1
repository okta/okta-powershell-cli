...
function New-PushProvider {
    ...
    Process {
        'Calling method: New-PushProvider' | Write-Debug
...
None
#>
function Invoke-DeletePushProvider {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeletePushProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-PushProvider {
    ...
    Process {
        'Calling method: Get-PushProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PushProvider[]
#>
function Invoke-ListPushProviders {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-ListPushProviders' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-PushProvider {
    ...
    Process {
        'Calling method: Update-PushProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
