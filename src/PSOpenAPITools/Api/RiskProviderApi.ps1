...
function New-RiskProvider {
    ...
    Process {
        'Calling method: New-RiskProvider' | Write-Debug
...
None
#>
function Invoke-DeleteRiskProvider {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeleteRiskProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-RiskProvider {
    ...
    Process {
        'Calling method: Get-RiskProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
RiskProvider[]
#>
function Invoke-ListRiskProviders {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-ListRiskProviders' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-RiskProvider {
    ...
    Process {
        'Calling method: Update-RiskProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
