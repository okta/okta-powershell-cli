...
#>
function New-PrincipalRateLimitEntity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-PrincipalRateLimitEntity' | Write-Debug
...
PrincipalRateLimitEntity
#>
function Get-PrincipalRateLimitEntity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-PrincipalRateLimitEntity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PrincipalRateLimitEntity[]
#>
function Invoke-ListPrincipalRateLimitEntities {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ListPrincipalRateLimitEntities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PrincipalRateLimitEntity
#>
function Update-PrincipalRateLimitEntity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-PrincipalRateLimitEntity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
