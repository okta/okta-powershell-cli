...
None
#>
function Invoke-ActivateDevice {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ActivateDevice' | Write-Debug
...
None
#>
function Invoke-DeactivateDevice {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeactivateDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Invoke-DeleteDevice {
    ...
    Process {
        'Calling method: Invoke-DeleteDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Suspend-Device {
    ...
    Process {
        'Calling method: Suspend-Device' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-UnsuspendDevice {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-UnsuspendDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
