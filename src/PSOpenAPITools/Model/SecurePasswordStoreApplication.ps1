...
function Initialize-SecurePasswordStoreApplication {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurePasswordStoreApplication' | Write-Debug
...
SecurePasswordStoreApplication<PSCustomObject>
#>
function ConvertFrom-JsonToSecurePasswordStoreApplication {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurePasswordStoreApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurePasswordStoreApplication
