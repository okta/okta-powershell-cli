...
function Initialize-U2fUserFactor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => U2fUserFactor' | Write-Debug
...
U2fUserFactor<PSCustomObject>
#>
function ConvertFrom-JsonToU2fUserFactor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => U2fUserFactor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in U2fUserFactor
