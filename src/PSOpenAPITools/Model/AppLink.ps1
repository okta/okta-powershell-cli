...
function Initialize-AppLink {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppLink' | Write-Debug
...
AppLink<PSCustomObject>
#>
function ConvertFrom-JsonToAppLink {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppLink' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppLink
