...
function Initialize-AgentPoolUpdateSetting {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AgentPoolUpdateSetting' | Write-Debug
...
AgentPoolUpdateSetting<PSCustomObject>
#>
function ConvertFrom-JsonToAgentPoolUpdateSetting {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AgentPoolUpdateSetting' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AgentPoolUpdateSetting
