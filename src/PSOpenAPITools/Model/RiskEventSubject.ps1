...
function Initialize-RiskEventSubject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RiskEventSubject' | Write-Debug
...
RiskEventSubject<PSCustomObject>
#>
function ConvertFrom-JsonToRiskEventSubject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RiskEventSubject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RiskEventSubject
