...
function Initialize-AutoLoginApplicationSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AutoLoginApplicationSettings' | Write-Debug
...
AutoLoginApplicationSettings<PSCustomObject>
#>
function ConvertFrom-JsonToAutoLoginApplicationSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AutoLoginApplicationSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AutoLoginApplicationSettings
