...
function Initialize-OpenIdConnectApplication {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OpenIdConnectApplication' | Write-Debug
...
OpenIdConnectApplication<PSCustomObject>
#>
function ConvertFrom-JsonToOpenIdConnectApplication {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OpenIdConnectApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OpenIdConnectApplication
