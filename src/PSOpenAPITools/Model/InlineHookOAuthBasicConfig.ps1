...
function Initialize-InlineHookOAuthBasicConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InlineHookOAuthBasicConfig' | Write-Debug
...
InlineHookOAuthBasicConfig<PSCustomObject>
#>
function ConvertFrom-JsonToInlineHookOAuthBasicConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InlineHookOAuthBasicConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InlineHookOAuthBasicConfig
