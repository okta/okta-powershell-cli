...
function Initialize-DeviceAccessPolicyRuleCondition {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeviceAccessPolicyRuleCondition' | Write-Debug
...
DeviceAccessPolicyRuleCondition<PSCustomObject>
#>
function ConvertFrom-JsonToDeviceAccessPolicyRuleCondition {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeviceAccessPolicyRuleCondition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeviceAccessPolicyRuleCondition
