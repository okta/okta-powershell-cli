...
function Initialize-SecurePasswordStoreApplicationSettingsApplication {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurePasswordStoreApplicationSettingsApplication' | Write-Debug
...
SecurePasswordStoreApplicationSettingsApplication<PSCustomObject>
#>
function ConvertFrom-JsonToSecurePasswordStoreApplicationSettingsApplication {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurePasswordStoreApplicationSettingsApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurePasswordStoreApplicationSettingsApplication
