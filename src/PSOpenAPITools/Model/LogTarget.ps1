...
function Initialize-LogTarget {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LogTarget' | Write-Debug
...
LogTarget<PSCustomObject>
#>
function ConvertFrom-JsonToLogTarget {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LogTarget' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LogTarget
