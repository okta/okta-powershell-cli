...
function Initialize-WellKnownOrgMetadataSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WellKnownOrgMetadataSettings' | Write-Debug
...
WellKnownOrgMetadataSettings<PSCustomObject>
#>
function ConvertFrom-JsonToWellKnownOrgMetadataSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WellKnownOrgMetadataSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WellKnownOrgMetadataSettings
