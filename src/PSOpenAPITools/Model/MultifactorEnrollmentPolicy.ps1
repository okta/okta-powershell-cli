...
function Initialize-MultifactorEnrollmentPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MultifactorEnrollmentPolicy' | Write-Debug
...
MultifactorEnrollmentPolicy<PSCustomObject>
#>
function ConvertFrom-JsonToMultifactorEnrollmentPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MultifactorEnrollmentPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MultifactorEnrollmentPolicy
