...
function Initialize-ResetPasswordToken {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ResetPasswordToken' | Write-Debug
...
ResetPasswordToken<PSCustomObject>
#>
function ConvertFrom-JsonToResetPasswordToken {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ResetPasswordToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ResetPasswordToken
