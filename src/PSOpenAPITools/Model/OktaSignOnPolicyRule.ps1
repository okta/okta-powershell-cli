...
function Initialize-OktaSignOnPolicyRule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OktaSignOnPolicyRule' | Write-Debug
...
OktaSignOnPolicyRule<PSCustomObject>
#>
function ConvertFrom-JsonToOktaSignOnPolicyRule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OktaSignOnPolicyRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OktaSignOnPolicyRule
