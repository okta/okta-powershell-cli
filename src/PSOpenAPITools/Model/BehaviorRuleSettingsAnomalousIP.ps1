...
function Initialize-BehaviorRuleSettingsAnomalousIP {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BehaviorRuleSettingsAnomalousIP' | Write-Debug
...
BehaviorRuleSettingsAnomalousIP<PSCustomObject>
#>
function ConvertFrom-JsonToBehaviorRuleSettingsAnomalousIP {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BehaviorRuleSettingsAnomalousIP' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BehaviorRuleSettingsAnomalousIP
