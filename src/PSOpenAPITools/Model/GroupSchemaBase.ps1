...
function Initialize-GroupSchemaBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GroupSchemaBase' | Write-Debug
...
GroupSchemaBase<PSCustomObject>
#>
function ConvertFrom-JsonToGroupSchemaBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GroupSchemaBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroupSchemaBase
