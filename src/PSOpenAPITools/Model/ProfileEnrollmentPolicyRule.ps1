...
function Initialize-ProfileEnrollmentPolicyRule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProfileEnrollmentPolicyRule' | Write-Debug
...
ProfileEnrollmentPolicyRule<PSCustomObject>
#>
function ConvertFrom-JsonToProfileEnrollmentPolicyRule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProfileEnrollmentPolicyRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProfileEnrollmentPolicyRule
