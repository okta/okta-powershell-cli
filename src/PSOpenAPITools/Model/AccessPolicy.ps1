...
function Initialize-AccessPolicy {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccessPolicy' | Write-Debug
...
AccessPolicy<PSCustomObject>
#>
function ConvertFrom-JsonToAccessPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccessPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccessPolicy
