...
function Initialize-LogStream {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LogStream' | Write-Debug
...
LogStream<PSCustomObject>
#>
function ConvertFrom-JsonToLogStream {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LogStream' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LogStream
