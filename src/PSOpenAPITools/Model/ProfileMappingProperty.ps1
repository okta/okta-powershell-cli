...
function Initialize-ProfileMappingProperty {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProfileMappingProperty' | Write-Debug
...
ProfileMappingProperty<PSCustomObject>
#>
function ConvertFrom-JsonToProfileMappingProperty {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProfileMappingProperty' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProfileMappingProperty
