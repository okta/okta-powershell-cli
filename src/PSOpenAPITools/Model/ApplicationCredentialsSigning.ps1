...
function Initialize-ApplicationCredentialsSigning {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationCredentialsSigning' | Write-Debug
...
ApplicationCredentialsSigning<PSCustomObject>
#>
function ConvertFrom-JsonToApplicationCredentialsSigning {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationCredentialsSigning' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApplicationCredentialsSigning
