...
function Initialize-ApplicationGroupAssignment {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationGroupAssignment' | Write-Debug
...
ApplicationGroupAssignment<PSCustomObject>
#>
function ConvertFrom-JsonToApplicationGroupAssignment {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationGroupAssignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApplicationGroupAssignment
