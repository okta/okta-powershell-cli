...
function Initialize-BasicAuthApplication {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BasicAuthApplication' | Write-Debug
...
BasicAuthApplication<PSCustomObject>
#>
function ConvertFrom-JsonToBasicAuthApplication {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BasicAuthApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BasicAuthApplication
