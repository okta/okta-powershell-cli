...
function Initialize-Protocol {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Protocol' | Write-Debug
...
Protocol<PSCustomObject>
#>
function ConvertFrom-JsonToProtocol {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Protocol' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Protocol
