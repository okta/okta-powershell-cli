...
function Initialize-KnowledgeConstraint {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KnowledgeConstraint' | Write-Debug
...
KnowledgeConstraint<PSCustomObject>
#>
function ConvertFrom-JsonToKnowledgeConstraint {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KnowledgeConstraint' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KnowledgeConstraint
