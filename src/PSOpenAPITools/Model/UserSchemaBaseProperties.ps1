...
function Initialize-UserSchemaBaseProperties {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserSchemaBaseProperties' | Write-Debug
...
UserSchemaBaseProperties<PSCustomObject>
#>
function ConvertFrom-JsonToUserSchemaBaseProperties {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserSchemaBaseProperties' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserSchemaBaseProperties
