...
function Initialize-SecurePasswordStoreApplicationSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurePasswordStoreApplicationSettings' | Write-Debug
...
SecurePasswordStoreApplicationSettings<PSCustomObject>
#>
function ConvertFrom-JsonToSecurePasswordStoreApplicationSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurePasswordStoreApplicationSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurePasswordStoreApplicationSettings
