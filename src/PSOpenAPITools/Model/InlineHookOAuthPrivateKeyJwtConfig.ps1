...
function Initialize-InlineHookOAuthPrivateKeyJwtConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InlineHookOAuthPrivateKeyJwtConfig' | Write-Debug
...
InlineHookOAuthPrivateKeyJwtConfig<PSCustomObject>
#>
function ConvertFrom-JsonToInlineHookOAuthPrivateKeyJwtConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InlineHookOAuthPrivateKeyJwtConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InlineHookOAuthPrivateKeyJwtConfig
