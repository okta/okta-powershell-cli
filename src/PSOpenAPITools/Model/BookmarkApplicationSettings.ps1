...
function Initialize-BookmarkApplicationSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BookmarkApplicationSettings' | Write-Debug
...
BookmarkApplicationSettings<PSCustomObject>
#>
function ConvertFrom-JsonToBookmarkApplicationSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BookmarkApplicationSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BookmarkApplicationSettings
