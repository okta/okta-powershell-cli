...
function Initialize-GroupLinks {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GroupLinks' | Write-Debug
...
function ConvertFrom-JsonToGroupLinks {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GroupLinks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
