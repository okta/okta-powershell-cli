...
function Initialize-AccessPolicyConstraint {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccessPolicyConstraint' | Write-Debug
...
AccessPolicyConstraint<PSCustomObject>
#>
function ConvertFrom-JsonToAccessPolicyConstraint {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccessPolicyConstraint' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccessPolicyConstraint
