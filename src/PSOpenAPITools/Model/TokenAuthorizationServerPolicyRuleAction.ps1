...
function Initialize-TokenAuthorizationServerPolicyRuleAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TokenAuthorizationServerPolicyRuleAction' | Write-Debug
...
TokenAuthorizationServerPolicyRuleAction<PSCustomObject>
#>
function ConvertFrom-JsonToTokenAuthorizationServerPolicyRuleAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TokenAuthorizationServerPolicyRuleAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TokenAuthorizationServerPolicyRuleAction
