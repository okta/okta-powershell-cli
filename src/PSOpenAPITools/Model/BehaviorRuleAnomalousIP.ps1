...
function Initialize-BehaviorRuleAnomalousIP {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BehaviorRuleAnomalousIP' | Write-Debug
...
BehaviorRuleAnomalousIP<PSCustomObject>
#>
function ConvertFrom-JsonToBehaviorRuleAnomalousIP {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BehaviorRuleAnomalousIP' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BehaviorRuleAnomalousIP
