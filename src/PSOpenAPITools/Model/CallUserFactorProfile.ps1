...
function Initialize-CallUserFactorProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CallUserFactorProfile' | Write-Debug
...
CallUserFactorProfile<PSCustomObject>
#>
function ConvertFrom-JsonToCallUserFactorProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CallUserFactorProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CallUserFactorProfile
