...
function Initialize-BehaviorRuleAnomalousDevice {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BehaviorRuleAnomalousDevice' | Write-Debug
...
BehaviorRuleAnomalousDevice<PSCustomObject>
#>
function ConvertFrom-JsonToBehaviorRuleAnomalousDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BehaviorRuleAnomalousDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BehaviorRuleAnomalousDevice
