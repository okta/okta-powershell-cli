...
function Initialize-SecurityQuestionUserFactor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SecurityQuestionUserFactor' | Write-Debug
...
SecurityQuestionUserFactor<PSCustomObject>
#>
function ConvertFrom-JsonToSecurityQuestionUserFactor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SecurityQuestionUserFactor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurityQuestionUserFactor
