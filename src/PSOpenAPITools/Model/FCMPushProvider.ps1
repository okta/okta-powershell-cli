...
function Initialize-FCMPushProvider {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FCMPushProvider' | Write-Debug
...
FCMPushProvider<PSCustomObject>
#>
function ConvertFrom-JsonToFCMPushProvider {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FCMPushProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FCMPushProvider
