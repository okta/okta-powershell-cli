...
function Initialize-BehaviorDetectionRuleSettingsBasedOnEventHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BehaviorDetectionRuleSettingsBasedOnEventHistory' | Write-Debug
...
BehaviorDetectionRuleSettingsBasedOnEventHistory<PSCustomObject>
#>
function ConvertFrom-JsonToBehaviorDetectionRuleSettingsBasedOnEventHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BehaviorDetectionRuleSettingsBasedOnEventHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BehaviorDetectionRuleSettingsBasedOnEventHistory
