...
function Initialize-ProfileEnrollmentPolicyRuleActions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProfileEnrollmentPolicyRuleActions' | Write-Debug
...
ProfileEnrollmentPolicyRuleActions<PSCustomObject>
#>
function ConvertFrom-JsonToProfileEnrollmentPolicyRuleActions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProfileEnrollmentPolicyRuleActions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProfileEnrollmentPolicyRuleActions
