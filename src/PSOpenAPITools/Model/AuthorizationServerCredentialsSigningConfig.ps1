...
function Initialize-AuthorizationServerCredentialsSigningConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuthorizationServerCredentialsSigningConfig' | Write-Debug
...
AuthorizationServerCredentialsSigningConfig<PSCustomObject>
#>
function ConvertFrom-JsonToAuthorizationServerCredentialsSigningConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuthorizationServerCredentialsSigningConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuthorizationServerCredentialsSigningConfig
