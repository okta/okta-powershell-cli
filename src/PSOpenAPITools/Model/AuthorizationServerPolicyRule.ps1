...
function Initialize-AuthorizationServerPolicyRule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuthorizationServerPolicyRule' | Write-Debug
...
AuthorizationServerPolicyRule<PSCustomObject>
#>
function ConvertFrom-JsonToAuthorizationServerPolicyRule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuthorizationServerPolicyRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuthorizationServerPolicyRule
