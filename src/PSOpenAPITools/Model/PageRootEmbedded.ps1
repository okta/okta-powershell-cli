...
function Initialize-PageRootEmbedded {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PageRootEmbedded' | Write-Debug
...
PageRootEmbedded<PSCustomObject>
#>
function ConvertFrom-JsonToPageRootEmbedded {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PageRootEmbedded' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageRootEmbedded
