...
function Initialize-LogStreamSettingsSplunkAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LogStreamSettingsSplunkAllOf' | Write-Debug
...
LogStreamSettingsSplunkAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToLogStreamSettingsSplunkAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LogStreamSettingsSplunkAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LogStreamSettingsSplunkAllOf
