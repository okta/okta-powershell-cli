...
function Initialize-EventHookChannelConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EventHookChannelConfig' | Write-Debug
...
EventHookChannelConfig<PSCustomObject>
#>
function ConvertFrom-JsonToEventHookChannelConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EventHookChannelConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EventHookChannelConfig
