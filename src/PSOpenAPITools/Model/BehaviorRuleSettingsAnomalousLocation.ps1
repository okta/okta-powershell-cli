...
function Initialize-BehaviorRuleSettingsAnomalousLocation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BehaviorRuleSettingsAnomalousLocation' | Write-Debug
...
BehaviorRuleSettingsAnomalousLocation<PSCustomObject>
#>
function ConvertFrom-JsonToBehaviorRuleSettingsAnomalousLocation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BehaviorRuleSettingsAnomalousLocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BehaviorRuleSettingsAnomalousLocation
