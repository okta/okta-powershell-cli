...
function Initialize-IdentityProviderApplicationUser {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IdentityProviderApplicationUser' | Write-Debug
...
IdentityProviderApplicationUser<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityProviderApplicationUser {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IdentityProviderApplicationUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IdentityProviderApplicationUser
