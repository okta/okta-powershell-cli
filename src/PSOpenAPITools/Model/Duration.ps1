...
function Initialize-Duration {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Duration' | Write-Debug
...
Duration<PSCustomObject>
#>
function ConvertFrom-JsonToDuration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Duration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Duration
