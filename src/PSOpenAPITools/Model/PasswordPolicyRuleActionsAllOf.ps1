...
function Initialize-PasswordPolicyRuleActionsAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PasswordPolicyRuleActionsAllOf' | Write-Debug
...
PasswordPolicyRuleActionsAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToPasswordPolicyRuleActionsAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PasswordPolicyRuleActionsAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PasswordPolicyRuleActionsAllOf
