...
function Initialize-CAPTCHAInstance {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CAPTCHAInstance' | Write-Debug
...
CAPTCHAInstance<PSCustomObject>
#>
function ConvertFrom-JsonToCAPTCHAInstance {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CAPTCHAInstance' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CAPTCHAInstance
