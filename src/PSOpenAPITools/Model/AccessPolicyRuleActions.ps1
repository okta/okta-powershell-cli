...
function Initialize-AccessPolicyRuleActions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccessPolicyRuleActions' | Write-Debug
...
AccessPolicyRuleActions<PSCustomObject>
#>
function ConvertFrom-JsonToAccessPolicyRuleActions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccessPolicyRuleActions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccessPolicyRuleActions
