...
function Initialize-ProtocolEndpoints {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProtocolEndpoints' | Write-Debug
...
ProtocolEndpoints<PSCustomObject>
#>
function ConvertFrom-JsonToProtocolEndpoints {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProtocolEndpoints' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProtocolEndpoints
