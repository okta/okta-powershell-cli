...
function Initialize-SwaApplicationSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SwaApplicationSettings' | Write-Debug
...
SwaApplicationSettings<PSCustomObject>
#>
function ConvertFrom-JsonToSwaApplicationSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SwaApplicationSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SwaApplicationSettings
