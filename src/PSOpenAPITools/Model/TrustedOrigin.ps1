...
function Initialize-TrustedOrigin {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrustedOrigin' | Write-Debug
...
TrustedOrigin<PSCustomObject>
#>
function ConvertFrom-JsonToTrustedOrigin {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrustedOrigin' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrustedOrigin
