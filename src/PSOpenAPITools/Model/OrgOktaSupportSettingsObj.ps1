...
function Initialize-OrgOktaSupportSettingsObj {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrgOktaSupportSettingsObj' | Write-Debug
...
OrgOktaSupportSettingsObj<PSCustomObject>
#>
function ConvertFrom-JsonToOrgOktaSupportSettingsObj {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrgOktaSupportSettingsObj' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrgOktaSupportSettingsObj
