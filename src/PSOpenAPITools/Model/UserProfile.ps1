...
function Initialize-UserProfile {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserProfile' | Write-Debug
...
UserProfile<PSCustomObject>
#>
function ConvertFrom-JsonToUserProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $UserProfileAdditionalProperties = @{}

        # check if Json contains properties not defined in UserProfile
        ...
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            ...
            if (!($AllProperties.Contains($name))) {
                $UserProfileAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "userType" = ${UserType}
            "zipCode" = ${ZipCode}
            "AdditionalProperties" = $UserProfileAdditionalProperties
        }
