...
function Initialize-LogActor {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LogActor' | Write-Debug
...
LogActor<PSCustomObject>
#>
function ConvertFrom-JsonToLogActor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LogActor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LogActor
