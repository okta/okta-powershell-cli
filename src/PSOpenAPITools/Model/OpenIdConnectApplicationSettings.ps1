...
function Initialize-OpenIdConnectApplicationSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OpenIdConnectApplicationSettings' | Write-Debug
...
OpenIdConnectApplicationSettings<PSCustomObject>
#>
function ConvertFrom-JsonToOpenIdConnectApplicationSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OpenIdConnectApplicationSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OpenIdConnectApplicationSettings
