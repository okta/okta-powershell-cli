...
function Initialize-BehaviorRuleSettingsHistoryBased {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BehaviorRuleSettingsHistoryBased' | Write-Debug
...
BehaviorRuleSettingsHistoryBased<PSCustomObject>
#>
function ConvertFrom-JsonToBehaviorRuleSettingsHistoryBased {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BehaviorRuleSettingsHistoryBased' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BehaviorRuleSettingsHistoryBased
