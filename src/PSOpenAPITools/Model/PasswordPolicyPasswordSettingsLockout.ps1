...
function Initialize-PasswordPolicyPasswordSettingsLockout {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PasswordPolicyPasswordSettingsLockout' | Write-Debug
...
PasswordPolicyPasswordSettingsLockout<PSCustomObject>
#>
function ConvertFrom-JsonToPasswordPolicyPasswordSettingsLockout {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PasswordPolicyPasswordSettingsLockout' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PasswordPolicyPasswordSettingsLockout
