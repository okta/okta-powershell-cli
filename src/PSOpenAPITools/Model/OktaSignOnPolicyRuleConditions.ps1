...
function Initialize-OktaSignOnPolicyRuleConditions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OktaSignOnPolicyRuleConditions' | Write-Debug
...
OktaSignOnPolicyRuleConditions<PSCustomObject>
#>
function ConvertFrom-JsonToOktaSignOnPolicyRuleConditions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OktaSignOnPolicyRuleConditions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OktaSignOnPolicyRuleConditions
