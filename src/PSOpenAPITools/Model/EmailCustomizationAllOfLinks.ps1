...
function Initialize-EmailCustomizationAllOfLinks {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailCustomizationAllOfLinks' | Write-Debug
...
EmailCustomizationAllOfLinks<PSCustomObject>
#>
function ConvertFrom-JsonToEmailCustomizationAllOfLinks {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailCustomizationAllOfLinks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailCustomizationAllOfLinks
