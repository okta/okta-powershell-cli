...
function Initialize-SwaApplicationSettingsApplication {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SwaApplicationSettingsApplication' | Write-Debug
...
SwaApplicationSettingsApplication<PSCustomObject>
#>
function ConvertFrom-JsonToSwaApplicationSettingsApplication {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SwaApplicationSettingsApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SwaApplicationSettingsApplication
