...
function Initialize-OAuth2RefreshToken {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OAuth2RefreshToken' | Write-Debug
...
OAuth2RefreshToken<PSCustomObject>
#>
function ConvertFrom-JsonToOAuth2RefreshToken {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OAuth2RefreshToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OAuth2RefreshToken
