...
function Initialize-OktaSignOnPolicyRuleActions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OktaSignOnPolicyRuleActions' | Write-Debug
...
OktaSignOnPolicyRuleActions<PSCustomObject>
#>
function ConvertFrom-JsonToOktaSignOnPolicyRuleActions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OktaSignOnPolicyRuleActions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OktaSignOnPolicyRuleActions
