...
function Initialize-AuthorizationServerPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuthorizationServerPolicy' | Write-Debug
...
AuthorizationServerPolicy<PSCustomObject>
#>
function ConvertFrom-JsonToAuthorizationServerPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuthorizationServerPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuthorizationServerPolicy
