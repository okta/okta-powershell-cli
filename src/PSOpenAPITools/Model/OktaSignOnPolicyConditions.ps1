...
function Initialize-OktaSignOnPolicyConditions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OktaSignOnPolicyConditions' | Write-Debug
...
OktaSignOnPolicyConditions<PSCustomObject>
#>
function ConvertFrom-JsonToOktaSignOnPolicyConditions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OktaSignOnPolicyConditions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OktaSignOnPolicyConditions
