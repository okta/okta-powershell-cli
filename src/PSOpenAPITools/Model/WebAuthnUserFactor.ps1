...
function Initialize-WebAuthnUserFactor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebAuthnUserFactor' | Write-Debug
...
WebAuthnUserFactor<PSCustomObject>
#>
function ConvertFrom-JsonToWebAuthnUserFactor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebAuthnUserFactor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebAuthnUserFactor
