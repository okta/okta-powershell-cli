...
function Initialize-ContextPolicyRuleCondition {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContextPolicyRuleCondition' | Write-Debug
...
ContextPolicyRuleCondition<PSCustomObject>
#>
function ConvertFrom-JsonToContextPolicyRuleCondition {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContextPolicyRuleCondition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContextPolicyRuleCondition
