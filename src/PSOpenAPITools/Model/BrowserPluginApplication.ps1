...
function Initialize-BrowserPluginApplication {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BrowserPluginApplication' | Write-Debug
...
BrowserPluginApplication<PSCustomObject>
#>
function ConvertFrom-JsonToBrowserPluginApplication {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BrowserPluginApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BrowserPluginApplication
