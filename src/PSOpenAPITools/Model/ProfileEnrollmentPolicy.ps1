...
function Initialize-ProfileEnrollmentPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProfileEnrollmentPolicy' | Write-Debug
...
ProfileEnrollmentPolicy<PSCustomObject>
#>
function ConvertFrom-JsonToProfileEnrollmentPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProfileEnrollmentPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProfileEnrollmentPolicy
