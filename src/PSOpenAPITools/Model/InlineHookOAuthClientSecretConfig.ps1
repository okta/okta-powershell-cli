...
function Initialize-InlineHookOAuthClientSecretConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InlineHookOAuthClientSecretConfig' | Write-Debug
...
InlineHookOAuthClientSecretConfig<PSCustomObject>
#>
function ConvertFrom-JsonToInlineHookOAuthClientSecretConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InlineHookOAuthClientSecretConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InlineHookOAuthClientSecretConfig
