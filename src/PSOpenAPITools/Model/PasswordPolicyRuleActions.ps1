...
function Initialize-PasswordPolicyRuleActions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PasswordPolicyRuleActions' | Write-Debug
...
PasswordPolicyRuleActions<PSCustomObject>
#>
function ConvertFrom-JsonToPasswordPolicyRuleActions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PasswordPolicyRuleActions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PasswordPolicyRuleActions
