...
function Initialize-BehaviorRuleVelocity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BehaviorRuleVelocity' | Write-Debug
...
BehaviorRuleVelocity<PSCustomObject>
#>
function ConvertFrom-JsonToBehaviorRuleVelocity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BehaviorRuleVelocity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BehaviorRuleVelocity
