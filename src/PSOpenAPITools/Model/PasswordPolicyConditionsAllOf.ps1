...
function Initialize-PasswordPolicyConditionsAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PasswordPolicyConditionsAllOf' | Write-Debug
...
PasswordPolicyConditionsAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToPasswordPolicyConditionsAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PasswordPolicyConditionsAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PasswordPolicyConditionsAllOf
