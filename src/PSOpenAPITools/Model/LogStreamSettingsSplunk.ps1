...
LogStreamSettingsSplunk<PSCustomObject>
#>

function Initialize-LogStreamSettingsSplunk {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LogStreamSettingsSplunk' | Write-Debug
...
Convert from JSON to LogStreamSettingsSplunk<PSCustomObject>
...
LogStreamSettingsSplunk<PSCustomObject>
#>
function ConvertFrom-JsonToLogStreamSettingsSplunk {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LogStreamSettingsSplunk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LogStreamSettingsSplunk
