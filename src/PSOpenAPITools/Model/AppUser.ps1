...
function Initialize-AppUser {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppUser' | Write-Debug
...
AppUser<PSCustomObject>
#>
function ConvertFrom-JsonToAppUser {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppUser
