...
function Initialize-GroupSchemaAttribute {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GroupSchemaAttribute' | Write-Debug
...
GroupSchemaAttribute<PSCustomObject>
#>
function ConvertFrom-JsonToGroupSchemaAttribute {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GroupSchemaAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroupSchemaAttribute
