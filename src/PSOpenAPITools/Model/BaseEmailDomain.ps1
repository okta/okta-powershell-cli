...
function Initialize-BaseEmailDomain {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BaseEmailDomain' | Write-Debug
...
BaseEmailDomain<PSCustomObject>
#>
function ConvertFrom-JsonToBaseEmailDomain {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BaseEmailDomain' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BaseEmailDomain
