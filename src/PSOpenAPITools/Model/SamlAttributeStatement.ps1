...
function Initialize-SamlAttributeStatement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SamlAttributeStatement' | Write-Debug
...
SamlAttributeStatement<PSCustomObject>
#>
function ConvertFrom-JsonToSamlAttributeStatement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SamlAttributeStatement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SamlAttributeStatement
