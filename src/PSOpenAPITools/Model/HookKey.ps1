...
function Initialize-HookKey {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => HookKey' | Write-Debug
...
HookKey<PSCustomObject>
#>
function ConvertFrom-JsonToHookKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => HookKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in HookKey
