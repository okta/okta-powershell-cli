...
function Initialize-ApiToken {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiToken' | Write-Debug
...
ApiToken<PSCustomObject>
#>
function ConvertFrom-JsonToApiToken {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiToken
