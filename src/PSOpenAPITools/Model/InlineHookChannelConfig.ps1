...
function Initialize-InlineHookChannelConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InlineHookChannelConfig' | Write-Debug
...
InlineHookChannelConfig<PSCustomObject>
#>
function ConvertFrom-JsonToInlineHookChannelConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InlineHookChannelConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InlineHookChannelConfig
