...
function Initialize-PasswordPolicyRecoveryFactors {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PasswordPolicyRecoveryFactors' | Write-Debug
...
PasswordPolicyRecoveryFactors<PSCustomObject>
#>
function ConvertFrom-JsonToPasswordPolicyRecoveryFactors {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PasswordPolicyRecoveryFactors' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PasswordPolicyRecoveryFactors
