...
function Get-OktaOrgContactUser {
    ...
    Process {
        ...
        if (!$PSCmdlet.MyInvocation.BoundParameters.ContainsKey("ContactType") -or $null -eq $ContactType) {
...
function Update-OktaOrgContactUser {
    ...
    Process {
        ...
        if (!$PSCmdlet.MyInvocation.BoundParameters.ContainsKey("OrgContactUser") -or $null -eq $OrgContactUser) {
...
function Update-OktaOrgSetting {
    ...
    Process {
        ...
        if (!$PSCmdlet.MyInvocation.BoundParameters.ContainsKey("OrgSetting") -or $null -eq $OrgSetting) {
