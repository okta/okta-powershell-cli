...
function Get-OktaRoleSubscriptionByNotificationType {
    ...
    Process {
        ...
        if (!$PSCmdlet.MyInvocation.BoundParameters.ContainsKey("RoleTypeOrRoleId") -or $null -eq $RoleTypeOrRoleId) {
        ...
        if (!$PSCmdlet.MyInvocation.BoundParameters.ContainsKey("NotificationType") -or $null -eq $NotificationType) {
