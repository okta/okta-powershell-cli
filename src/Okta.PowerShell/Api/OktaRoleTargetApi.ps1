...
function Add-OktaApplicationInstanceTargetToAppAdminRoleGivenToGroup {
    ...
    Process {
        ...
        if (!$PSCmdlet.MyInvocation.BoundParameters.ContainsKey("ApplicationId") -or $null -eq $ApplicationId) {
...
function Add-OktaGroupTargetToGroupAdministratorRoleForGroup {
    ...
    Process {
        ...
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
        if (!$PSCmdlet.MyInvocation.BoundParameters.ContainsKey("TargetGroupId") -or $null -eq $TargetGroupId) {
