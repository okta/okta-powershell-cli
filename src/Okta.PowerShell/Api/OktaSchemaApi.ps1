...
function Get-OktaApplicationUserSchema {
    ...
    Process {
        ...
        if (!$PSBoundParameters.ContainsKey("AppInstanceId")) {
...
function Get-OktaLogStreamSchema {
    ...
    Process {
        ...
        if (!$PSBoundParameters.ContainsKey("LogStreamType")) {
...
function Get-OktaUserSchema {
    ...
    Process {
        ...
        if (!$PSBoundParameters.ContainsKey("SchemaId")) {
...
function Update-OktaGroupSchema {
    ...
    Process {
        ...
        if ($IncludeNullValues.IsPresent) {
            ...
            $LocalVarBodyParameter = Remove-NullProperties -InputObject $GroupSchema | ConvertTo-Json -Depth 100
        }
...
function Update-OktaUserProfile {
    ...
    Process {
        ...
        if ($IncludeNullValues.IsPresent) {
            ...
            $LocalVarBodyParameter = Remove-NullProperties -InputObject $UserSchema | ConvertTo-Json -Depth 100
        }
